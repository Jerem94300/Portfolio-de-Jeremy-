export const expMilitary = () => {
    ...
    btnDate.forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        if (btn.classList.contains("btn__2018__2020")) {
          ...
          descriptionItem1.textContent =
            "Adjudant d'unité de la Compagnie de Commandement et de Logistique";
          ...
          descriptionInsigne.textContent =
            "Groupement de Recrutement et de Selection IDF - OM";
          photoRegiment.src = "/assets/images/photoRecrutement.jpeg";
          descriptionItem1.textContent = "Conseiller en Recrutement";
          descriptionItem2.textContent = "Évaluateur en Recrutement";
          descriptionItem3.textContent = "";
          dateCurrent.textContent = btn.textContent;
        } else {
          ...
          descriptionItem1.textContent = "Chef de Peloton Blindé";
          descriptionItem2.textContent = "Sous-Officier Adjoint";
          descriptionItem3.textContent = "Militaire du Rang";
          dateCurrent.textContent = btn.textContent;
        }
      });
    });
  ...
  section.className = "experience__container fade-in";
  section.id = "military";
        ...
        <div class="images__military"></div>
            ...
            <div class="details__date">
                <div class="location__military">
                    <img src="/assets/images/image.png" class="localisation__image" alt="localisation Angoulême">
                    <div class="title__location">ANGOULÊME</div>
                </div>

                <div class="block__description">
                    <div class="block__insigne__rgt">
                        <img src="/assets/images/Sujet 2.png" class="insigne__rgt" alt="insigne 1er RIMa">
                    </div>
                    <div class="description__item0">1er RIMa</div>
                </div>

                <div class="images__military">
                    <img src="/assets/images/IMG_0456.jpg" class="image__mixRima" alt="Photos de missions">
                    <div class="description__item1">Chef de Peloton Blindé</div>
                    <div class="description__item2">Sous-Officier-Adjoint</div>
                    <div class="description__item3">Militaire du rang</div>
                </div>
            </div>
     </main>
  `;
