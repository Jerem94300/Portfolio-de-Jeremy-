  ...
  return `
    ...
    <div class="card__container">
        ...
        <div class="experience__card peintres__card" id="webdev"  onclick="window.location.href='https://artistespeintres.jeremyabelard.fr'">
          ...
          <div class="experience__card" id="military"   onclick="window.location.href='https://petitsplats.jeremyabelard.fr'">
        ...
        <button class="btn__back" onclick="window.location.href='experiences.html'">Back</button>
        </div>
    </div>
