...
loadPageContent("experiences", false); // Charge la version anglaise par défaut
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (toggle) {
    toggle.addEventListener("change", (event) => {
      ...
      loadPageContent("experiences", isFrench); // Charge la page dans la langue sélectionnée
    });
  }
});
